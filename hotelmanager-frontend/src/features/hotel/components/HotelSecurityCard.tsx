...
export default function HotelSecurityCard({
  ...
  return (
    <section className="rounded-xl border border-gray-100 bg-white/70 shadow-xl backdrop-blur-md transition-all duration-300">
      {/* Section header defining security and access settings */}
      ...
      <div className="p-8 grid gap-8">
        {/* Hotel activation status toggle */}
        <div className="flex flex-col items-center gap-3">
          ...
          >
            {isActive ? "Hotel active" : "Hotel disabled"}
          </div>
        </div>

        {/* Secure hotel access code input with visibility toggle */}
