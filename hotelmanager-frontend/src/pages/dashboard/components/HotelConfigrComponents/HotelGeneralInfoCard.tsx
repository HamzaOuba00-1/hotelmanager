...
import {Hotel, ImagePlus, Landmark, LocateFixed, Mail, MapPin, Phone,} from "lucide-react";
            ...
            <div className="p-8 grid gap-8">
                ...
                <div className="w-full flex justify-center mt-4">
                    <div className="flex items-center justify-center gap-6">
                        {/* Uploader */}
                        <label
                            className="w-64 aspect-[5/2] relative rounded-xl border-2 border-dashed border-emerald-400 bg-white/40 backdrop-blur-sm p-4 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-emerald-50 transition">
                ...
                Uploader un logo
                        ...
                        {/* Logo actuel */}
                        <div
                            className="w-64 aspect-[5/2] relative rounded-xl border-2 border-dashed border-gray-400 bg-white/40 backdrop-blur-sm p-4 flex flex-col items-center justify-center text-center transition">
                            {logoUrl ? (
                                <img
