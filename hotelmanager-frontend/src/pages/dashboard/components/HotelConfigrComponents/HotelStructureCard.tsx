import {BedDouble, Building2, CheckCircle2, Hotel, Landmark, Layers3, Trash2, Warehouse,} from "lucide-react";
        ...
        <section
            ...
            <div className="p-8 grid gap-8">
                ...
                <div className="grid gap-2">
                    ...
                    {floors > 0 ? (
                        <div
                            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-h-[320px] overflow-y-auto pr-1">
                            {Array.from({length: floorLabels.length}, (_, i) => (
                                ...
                                >
                                    <div
                                        className="flex items-center justify-center w-8 h-8 bg-emerald-100 text-emerald-700 rounded-full text-xs font-semibold shadow">
                                        {i === 0 ? "RDC" : i}
                                    </div>
                                    <input
                                        type="text"
