...
const LoginPage: React.FC = () => {
    ...
    return (
        <div
            className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-emerald-100 overflow-hidden font-sans">
            {/* Halo décoratif */}
            ...
            <div
                className="relative w-full max-w-md bg-white/40 backdrop-blur-lg border border-white/60 shadow-2xl rounded-3xl p-8 sm:p-10">
                ...
                {error && (
                    <div
                        className="mb-4 text-sm text-red-600 bg-red-50/70 border border-red-200 rounded-lg p-3 backdrop-blur-sm">
                        {error}
                    </div>
                )}
