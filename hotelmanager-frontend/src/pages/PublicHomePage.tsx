...
export default function PublicHomePage() {
  ...
  // on ne montre que les hôtels actifs pour la partie publique
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-emerald-50 via-white to-emerald-50">
      ...
      <main className="max-w-6xl mx-auto px-6 pb-16">
        {/* Hero */}
        <section className="mt-10 grid gap-10 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] items-center">
          {/* Colonne texte */}
          <div>
          ...
          {/* Colonne droite : petite carte “stats” */}
